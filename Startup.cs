    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            lifetime.ApplicationStarted.Register(() => {
                ...
                Console.WriteLine("test: " + Environment.GetEnvironmentVariable("ZIPKIN_ADDRESS"));
                var httpSender = new HttpZipkinSender(Environment.GetEnvironmentVariable("ZIPKIN_ADDRESS"), "application/json");
                var tracer = new ZipkinTracer(httpSender, new JSONSpanSerializer());
                TraceManager.RegisterTracer(tracer);
                TraceManager.Start(logger);
            });
            lifetime.ApplicationStopped.Register(() => TraceManager.Stop());
            app.UseTracing(Environment.GetEnvironmentVariable("APP_NAME"));
        }
